...
TOTAL_STEPS = 1200    # The total number of simulation steps for continuous (online) training.
...
state_size = 13   # (q_EB_0, q_EB_1, q_EB_2, q_SB_0, q_SB_1, q_SB_2, current_phase)
...
def get_state():  #3&4. Constraint 3 & 4
    global q_e_0, q_e_1, q_e_2, q_e_3, q_e_4, q_e_5, q_e_6, q_e_7, q_e_8, q_e_9, q_e_10, q_e_11, current_phase
    ...
    detector_e2_9 = "e2_9"
    detector_e2_10 = "e2_10"
    detector_e2_11 = "e2_11"


    # Traffic light ID
    traffic_light_id = "clusterJ23_J26_clusterJ18_J19_J20_cluster_11693513535_1783433672_1783433674_1783433694_#1more"
    
    # Get queue lengths from each detector
    q_e_0 = get_queue_length(detector_e2_0)
    q_e_1 = get_queue_length(detector_e2_1)
    q1_e_2 = get_queue_length(detector_e2_2)
    q_e_3 = get_queue_length(detector_e2_3)
    q_e_4 = get_queue_length(detector_e2_4)
    q_e_5 = get_queue_length(detector_e2_5)
    q_e_6 = get_queue_length(detector_e2_6)
    q_e_7 = get_queue_length(detector_Ne2_7)
    q_e_8 = get_queue_length(detector_e2_8)
    q_e_9 = get_queue_length(detector_e2_9)
    q_e_10 = get_queue_length(detector_e2_10)
    q_e_11 = get_queue_length(detector_e2_11)
    ...
    return (q_e_0, q_e_1, q1_e_2, q_e_3, q_e_4, q_e_5, q_e_6, q_e_7, q_e_8, q_e_9, q_e_10, q_e_11, current_phase)

def apply_action(action, tls_id="clusterJ23_J26_clusterJ18_J19_J20_cluster_11693513535_1783433672_1783433674_1783433694_#1more"): #5. Constraint 5
    """
